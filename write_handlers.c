 ...
 * @width: get width as our input in our case
 * @precision: precision specifier input
 * @size: Size specifier input too
 ...
 * @buffer: Buffer input
 * @flags: Flags input
 * @width: width as an input
 * @prec: Precision specifier an input
 * @length: Number length as input
 * @padd: Pading charactern input
 ...
 * @flags: Flags specifiers input
 * @width: Width specifier input
 * @precision: Precision specifier input
 ...
 * @length: Length of number input
 * @width: Width specifier input
 * @flags: Flags specifier input
 * @padd: Char representing the padding input
 * @extra_c: Char representing extra characters
 * @padd_start: Index at which padding should start input
 * Return: Number of written characters
 */
